<x-layouts.app :title="__('Ingresos Salle')">
    ...
    <div class="flex w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            ...
            <div
                class="relative aspect-video overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700">
                <form action="{{ route('facture.salle.imports') }}" method="post" enctype="multipart/form-data"
                    class="px-1 py-1">
                    @csrf
        ...
        <div class="relative flex-1 p-1 overflow-hidden rounded-xl border border-neutral-900 dark:border-neutral-700">
            ...
            <form action="{{ route('facture.salle') }}" method="get" class="px-1 py-1">
                @csrf
