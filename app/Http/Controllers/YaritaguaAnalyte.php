...
class YaritaguaAnalyte extends Controller
{
    ...
    {           
        return view('analytes.yaritagua', $this->fetchAnalyteData($request));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $modelName = AnalyteYaritagua::class;
